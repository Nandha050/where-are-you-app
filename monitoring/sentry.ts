...
const SENSITIVE_KEY_PATTERN = /(token|password|authorization|cookie|secret|api[-_]?key|refresh|fcm)/i;
...
export const addSentryBreadcrumb = (args: {
    ...
    Sentry.addBreadcrumb({
        ...
        type: args.type,
        data: args.data ? (sanitizeValue(args.data) as Record<string, unknown>) : undefined,
